...
export interface MiwaFrontendPipelineSourceProps {
...
export interface MiwaFrontendPipelineStackProps extends StackProps {
  readonly source: MiwaFrontendPipelineSourceProps;
  readonly repository: ecr.IRepository;
  readonly service: ecs.FargateService;
  readonly containerName: string;
}

export class MiwaFrontendPipelineStack extends Stack {
  constructor(
    scope: Construct,
    id: string,
    props: MiwaFrontendPipelineStackProps
  ) {
    ...
    const pipeline = new codepipeline.Pipeline(this, "MiwaFrontendPipeline", {
